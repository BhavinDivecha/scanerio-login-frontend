...
const Icon = {
  Google: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#EA4335"
        d="M12 10.2v3.9h5.4c-.2 1.3-1.6 3.8-5.4 3.8-3.2 0-5.9-2.7-5.9-5.9S8.8 6.1 12 6.1c1.8 0 3 .8 3.7 1.5l2.5-2.4C16.8 3.7 14.6 2.8 12 2.8 6.9 2.8 2.8 6.9 2.8 12S6.9 21.2 12 21.2c6.4 0 8.9-4.5 8.9-6.8 0-.5-.1-.8-.1-1.1H12z"
      />
    </svg>
  ),
  GitHub: () => (
  ...
  LinkedIn: () => (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#0A66C2"
        d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8.5h4V23h-4V8.5zM8 8.5h3.8v2h.1c.5-1 1.9-2.1 3.9-2.1 4.2 0 5 2.8 5 6.4V23h-4v-5.9c0-1.4 0-3.2-2-3.2s-2.3 1.5-2.3 3.1V23H8V8.5z"
      />
    </svg>
  ),
};
...
function OtpInput({
  ...
  const setInputRef =
    (i: number): React.RefCallback<HTMLInputElement> =>
    (el) => {
      inputs.current[i] = el;
    };
...
function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-3 text-sm font-medium transition outline-none focus-visible:ring-2";
  const styles = {
    default: {
